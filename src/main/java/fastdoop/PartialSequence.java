...
/**
 * This class is used to store fragments of a long input FASTA sequence as an
 * array of bytes.
 * 
...
public class PartialSequence implements Serializable {
	...
	public String toString() {
		return "PartialSequence [header=" + header + ", bufferSize=" + (endValue - startValue + 1) + ", startValue="
				+ startValue + ", endValue=" + endValue + ", bytesToProcess=" + bytesToProcess + "]";
	}
